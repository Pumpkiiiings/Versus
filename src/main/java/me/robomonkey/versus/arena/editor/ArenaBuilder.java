...
public class ArenaBuilder {
    ...
    private void finalizeArena() {
        builder.sendMessage(me.robomonkey.versus.config.model.Settings.getMessage(me.robomonkey.versus.config.model.Setting.ARENA_CREATED, me.robomonkey.versus.config.model.Placeholder.of("%arena%", targetArena.getName())));
