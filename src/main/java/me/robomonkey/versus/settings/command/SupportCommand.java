...
public class SupportCommand extends AbstractCommand {
    ...
    public void callCommand(CommandSender sender, String[] args) {
        TextComponent message = new TextComponent(MessageUtil.color(Settings.getMessage(Setting.ADMIN_SUPPORT_MESSAGE)));
        String hoverText = MessageUtil.color(Settings.getMessage(Setting.ADMIN_SUPPORT_HOVER));
