...
public class ReloadCommand extends AbstractCommand {
    ...
    public void callCommand(CommandSender sender, String[] args) {
        ...
        Settings.getInstance().reloadConfig(() -> {
            ...
            me.robomonkey.versus.kit.manager.KitManager.getInstance().reload();
            me.robomonkey.versus.arena.manager.ArenaManager.getInstance().loadArenas();
            me.robomonkey.versus.cosmetic.manager.CosmeticsManager.getInstance().loadConfigs();
