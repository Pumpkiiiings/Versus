...
public enum Setting {
    ...
    MILESTONE_BROADCAST_ENABLED("dueling.announcements", Type.BOOLEAN),
    MILESTONE_BROADCAST_MESSAGE("dueling.announcements", Type.STRING, FileType.MESSAGES),

    HISTORY_HEADER("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_EMPTY("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_ENTRY_WIN("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_ENTRY_LOSS("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_DATE_FORMAT("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_VS_HEADER("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_VS_SCORE("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_VS_EMPTY("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_VS_LEADING("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_VS_TRAILING("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_VS_TIED("history.messages", Type.STRING, FileType.MESSAGES),
    HISTORY_RIVALRY_NOTICE("history.messages", Type.STRING, FileType.MESSAGES),
    ...
    RANKED_RANK_UP("ranked.messages", Type.STRING, FileType.MESSAGES),
    RANKED_RANK_DOWN("ranked.messages", Type.STRING, FileType.MESSAGES),
    RANKED_RANK_UP_BROADCAST_ENABLED("ranked", Type.BOOLEAN),
    RANKED_RANK_UP_BROADCAST("ranked.messages", Type.STRING, FileType.MESSAGES),
