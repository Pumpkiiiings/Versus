...
public class DuelGroupAccept extends AbstractCommand {
    ...
    public void callCommand(CommandSender sender, String[] args) {
        ...
        if (party == null) {
            player.sendMessage(MessageUtil.color(me.robomonkey.versus.settings.Settings.getMessage(me.robomonkey.versus.settings.Setting.PARTY_DOES_NOT_EXIST)));
        ...
        party.broadcast(me.robomonkey.versus.settings.Settings.getMessage(me.robomonkey.versus.settings.Setting.PARTY_PLAYER_JOINED).replace("%player%", player.getName()));
    }
